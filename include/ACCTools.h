...
//template AddArray return arrSum (arrSum = arrA + arrB), which is the same type as arrA
//template AddArrayBtoA will Add arrB to arrA and store the sum in arrA, no return
//template CalculateRatio will return a double type array ratio, where rtio = numerator/denominator
//template cloneArray will return a copy of the given array
//template CopyToTypeT will return an array in typeT, converted from the content of the given array
...
//////////////////////////////////////////////////////////////////////////////
  ...
  /////////////////////////////////////////////////////////////////////////////
  //Add arrB to arrA and store the result in arrA
  template <typename T1, typename T2>
  void AddArrayBToA(T1 *****arrA, T2 *****arrB, int bin1, int bin2, int bin3, int bin4,int bin5)
  {
    for(int iw=0;iw<bin1;iw++)
    {
      for(int iq=0;iq<bin2;iq++)
      {
        for(int it=0;it<bin3;it++)
        {
          for(int ip=0;ip<bin4;ip++)
          {
            for(int i5=0;i5<bin4;i5++)
            {
              arrA[iw][iq][it][ip][i5] += (T1)(arrB[iw][iq][it][ip][i5]);
            }
          }
        }
      }
  ...
  template <typename T1, typename T2>
  void AddArrayBToA(T1 ****arrA, T2 ****arrB, int bin1, int bin2, int bin3, int bin4)
  {
    for(int iw=0;iw<bin1;iw++)
    {
      for(int iq=0;iq<bin2;iq++)
      {
        for(int it=0;it<bin3;it++)
        {
          for(int ip=0;ip<bin4;ip++)
          {
            arrA[iw][iq][it][ip] += (T1)(arrB[iw][iq][it][ip]);
          }
        }
      }
    }
  ...
  template <typename T1, typename T2>
  void AddArrayBToA(T1 ***arrA, T2 ***arrB, int bin1, int bin2, int bin3)
  {
    for(int iw=0;iw<bin1;iw++)
    {
      for(int iq=0;iq<bin2;iq++)
      {
        for(int it=0;it<bin3;it++)
        {
          arrA[iw][iq][it] += (T1)(arrB[iw][iq][it]);
        }
      }
    }
  }
  ...
  template <typename T1, typename T2>
  void AddArrayBToA(T1 **arrA, T2 **arrB, int bin1, int bin2)
  {
    for(int iw=0;iw<bin1;iw++)
    {
      for(int iq=0;iq<bin2;iq++)
      {
        arrA[iw][iq] += (arrB[iw][iq]);
      }
    }
  }

  template <typename T1, typename T2>
  void AddArrayBToA(T1 *arrA, T2 *arrB, int bin1)
  {
    for(int iw=0;iw<bin1;iw++)
    {
      arrA[iw] += (T1)(arrB[iw]);
  ...
  /////////////////////////////////////////////////////////////////////////////
  //Let arrSum = arrA + arrB, return arrSum which is the same type as arrA
  template <typename T1, typename T2>
  T1 ***** AddArray(T1 *****arrA, T2 *****arrB, int bin1, int bin2, int bin3, int bin4,int bin5)
  {
    T1 dDef = (T1)(0);
    T1 *****Sum = IniDynamicArray(bin1, bin2, bin3, bin4,bin5, dDef);
      ...
      for(int iq=0;iq<bin2;iq++)
      {
        for(int it=0;it<bin3;it++)
        {
          for(int ip=0;ip<bin4;ip++)
          {
            for(int i5=0;i5<bin4;i5++)
            {
              Sum[iw][iq][it][ip][i5] = arrA[iw][iq][it][ip][i5] + (T1)(arrB[iw][iq][it][ip][i5]);
            }
          }
        }
      }
  ...
  template <typename T1, typename T2>
  T1 **** AddArray(T1 ****arrA, T2 ****arrB, int bin1, int bin2, int bin3, int bin4)
  {
    T1 dDef = (T1)(0);
    T1 ****Sum = IniDynamicArray(bin1, bin2, bin3, bin4, dDef);
    ...
    for(int iw=0;iw<bin1;iw++)
    {
      for(int iq=0;iq<bin2;iq++)
      {
        for(int it=0;it<bin3;it++)
        {
          for(int ip=0;ip<bin4;ip++)
          {
            Sum[iw][iq][it][ip] = arrA[iw][iq][it][ip] + (T1)(arrB[iw][iq][it][ip]);
          }
        }
      }
    }
  ...
  template <typename T1, typename T2>
  T1 *** AddArray(T1 ***arrA, T2 ***arrB, int bin1, int bin2, int bin3)
  {
    T1 dDef = (T1)(0);
    T1 ***Sum = IniDynamicArray(bin1, bin2, bin3, dDef);
    ...
    for(int iw=0;iw<bin1;iw++)
    {
      for(int iq=0;iq<bin2;iq++)
      {
        for(int it=0;it<bin3;it++)
        {
          Sum[iw][iq][it] = arrA[iw][iq][it] + (T1)(arrB[iw][iq][it]);
        }
      }
    }
    return Sum;
  ...
  template <typename T1, typename T2>
  T1 ** AddArray(T1 **arrA, T2 **arrB, int bin1, int bin2)
  {
    T1 dDef = (T1)(0);
    T1 **Sum = IniDynamicArray(bin1, bin2, dDef);

    for(int iw=0;iw<bin1;iw++)
    {
      for(int iq=0;iq<bin2;iq++)
      {
        Sum[iw][iq] = arrA[iw][iq] + (T1)(arrB[iw][iq]);
      }
    }
    return Sum;
  }
  ...
  template <typename T1, typename T2>
  T1 * AddArray(T1 *arrA, T2 *arrB, int bin1)
  {
    T1 dDef = (T1)(0);
    T1 *Sum = IniDynamicArray(bin1, dDef);

    for(int iw=0;iw<bin1;iw++)
    {
      Sum[iw] = arrA[iw] + (T1)(arrB[iw]);
    }
    return Sum;
  }
                   ...
                   int removestart[4], int removeend[4], char **name=0, int precision=6)
  {
    ...
    for(int i=0;i<4;i++)
    {
      //check if the user given a wrong start or end index
      if( removestart[i]>=0 && removestart[i]<=removeend[i] && removeend[i]<newbin[i])
      {
        newbin[i]=newbin[i]-(removeend[i]-removestart[i]+1);
      }
      if (newbin[i]==0 || removestart[i]>removeend[i])
      {
        cout<<"Error in input! RemoveBins() can not shrink dimention. Check your removestart and removeend\n";
        return NULL;
      }
    }
